	...
	int gst_amount = 0;
				...
				
			{
				if(product[i]==productgsthigh)
				{
		           ...
		           Assert.assertSame(productgsthigh, product[i]);
				...
				System.out.println("the total amount paid for product with discount and  with out gst is:"+total_amount_discount);
		...
		private boolean assertTrue(int i) {
			// TODO Auto-generated method stub
			return false;
		}
